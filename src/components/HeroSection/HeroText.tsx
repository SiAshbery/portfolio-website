        ...
        <>
            ...
            <p className="text-[#ADB7BE] text-lg mb-6 md:mr-6 lg:text-xl">
                <span className="block mb-4">
                    I'm a Software Engineer with an artistic past. My journey from artist and
                    animator to tech expert emphasises merging creativity with technical know-how.
                </span>
                <span className="block mb-4">
                    With {yearsHence(yearGraduatedFromMakers)} years in web and app development and{' '}
                    {yearsHence(yearGrautatedFromUni)} in interactive media, I focus on crafting
                    innovative solutions that are grounded in my artistic roots and problem-solving,
                    aiming to make a positive impact through code, art and storytelling.
                </span>
                <span className="block mb-4">
